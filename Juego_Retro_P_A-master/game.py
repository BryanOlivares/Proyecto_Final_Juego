...
#mainloop
#codigo para el movimiento del sprite y deteccion de coliciones
font = pygame.font.SysFont('comicsans', 30, True)
man = player(100, 207, 64,64)
goblin = enemy(900, 200, 64, 64, 1040)
shootLoop = 0
bullets = []
run = True
while run:
    ...
    for bullet in bullets:
        ...
        if bullet.x < 1040 and bullet.x > 0:
            bullet.x += bullet.vel
        else:
            bullets.pop(bullets.index(bullet))
    ...
    if keys[pygame.K_LEFT] and man.x > man.vel:
        ...
        man.right = False
        man.standing = False
    elif keys[pygame.K_RIGHT] and man.x < 1040 - man.width - man.vel:
        man.x += man.vel
        man.right = True
        man.left = False
        man.standing = False
